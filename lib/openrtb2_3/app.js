...
var App = function(storeurl, cat, id, name, publisher, bundle, content){
...
AppBuilder.prototype.build = function() {
  var app = new App(this._storeurl, this._cat, this._id, this._name, this._publisher, this._bundle, this._content);
